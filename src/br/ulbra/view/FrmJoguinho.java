...
import br.ulbra.control.Jogo;

/**
 *
 * @author Jeferson Leon
 */
public class FrmJoguinho extends javax.swing.JFrame {

    /**
     * Creates new form FrmJoguinho
     */
    public FrmJoguinho() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("JOGO DO ACERTO!!");

        jLabel2.setFont(new java.awt.Font("Tempus Sans ITC", 1, 18)); // NOI18N
        jLabel2.setText("INFORME O Nº DA SORTE:");

        txtNum.setFont(new java.awt.Font("Tempus Sans ITC", 1, 36)); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        Jogo j = new Jogo();
        j.jogar(Integer.parseInt(txtNum.getText()));
